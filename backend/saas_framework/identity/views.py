...
class BasicAuthSigninView(APIView):
    def post(self, request):
        ...
        (refresh_token, access_token) = TokenUtils.signin(email=email, password=password)
...
class BasicAuthSignupView(APIView):
    def post(self, request):
        ...
        (refresh_token, access_token) = TokenUtils.signup(email=email, first_name=first_name, last_name=last_name, password=password)
        return Response({ 'refresh_token': refresh_token, 'access_token': access_token })
